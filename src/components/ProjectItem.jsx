            ...
            <div className='hidden group-hover:block absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]'>
                ...
                <div className='flex justify-center'>
                    ...
                    <a
                        ...
                        target='_blank'
                        rel='noopener noreferrer'
                        className='text-center mx-2 py-2 px-4 rounded-lg bg-gray-800 border-2 border-gray-800 text-white font-chicago font-bold cursor-pointer text-sm hover:text-gray-800 hover:bg-transparent dark:text-slate-800 dark:bg-gray-300 dark:border-gray-300 dark:hover:bg-slate-800 dark:hover:text-gray-300'
                    >
                        Code
                    </a>
                </div>
